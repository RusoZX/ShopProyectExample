...
import com.rzxengineering.shopapp.viewmodels.GiveSalesViewModel
import java.time.LocalDate
import kotlin.collections.ArrayList

class BuysFragment :Fragment(R.layout.buy_history_fragment){
    lateinit var navController: NavController
    lateinit var buysVM: GiveSalesViewModel
    lateinit var recyView: RecyclerView

    lateinit var buysAndRestocksAdapter: BuysAndRestocksAdapter
    lateinit var buysList: ArrayList<SaleOrRestock>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buysVM = ViewModelProvider(this)[GiveSalesViewModel::class.java]

        dateSpinner= requireView().findViewById(R.id.dateSpinnerBuy)
        quantitySpinner= requireView().findViewById(R.id.quantitySpinnerBuy)
        search = requireView().findViewById(R.id.searchBuy)
        ...
        search.setOnClickListener {
            if(dateSpinner.selectedItem.toString()==resources.getString(R.string.optionMsgDate)||
                ...
                buysVM.sales.observe(viewLifecycleOwner){
                    buysList=it
    ...
    private fun setAdapter(){
        ...
        buysAndRestocksAdapter= BuysAndRestocksAdapter(buysList,requireContext(),
            BuysListener(navController, buysList))
    ...
    private fun setDecorator(){
        recyView=requireView().findViewById(R.id.buyHistoryRecyView)
    ...
    class BuysListener(navController: NavController, list: ArrayList<SaleOrRestock>):
        ...
        override fun onBuyAndRestockClick(position: Int) {
            ...
            navController.navigate(R.id.action_buysFragment_to_productFragment, bundle)
        }
    }
